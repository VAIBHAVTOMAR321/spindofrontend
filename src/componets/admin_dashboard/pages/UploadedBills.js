...
const UploadedBills = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setAlertMessage(error.message || "Error updating bill");
      setAlertType("error");
      setShowAlertModal(true);
    } finally {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const response = await fetch(API_URL, {
        ...
        body: JSON.stringify({ id: deletingBillId }),
      });
      ...
      setAlertMessage(error.message || "Error deleting bill");
      setAlertType("error");
      setShowAlertModal(true);
    } finally {
      setDeletingBillId(null);
    ...
    <div className="dashboard-container">
              ...
              <Card className="shadow-lg border-0 rounded-4 p-3 animate__animated animate__fadeIn" style={{ backgroundColor: "#f8f9fa" }}>
                <Card.Body>
                  <div className="text-center mb-4">
                    ...
                    <p style={{ color: "#6c757d", fontSize: "14px" }}>View and manage uploaded bills.</p>
                  </div>
      ...
      <Modal show={showDeleteModal} onHide={handleCancelDelete} centered>
        <Modal.Header closeButton style={{ backgroundColor: "#f8fafc" }}>
          <Modal.Title style={{ fontWeight: 700 }}>Confirm Delete</Modal.Title>
        </Modal.Header>
        <Modal.Body>
